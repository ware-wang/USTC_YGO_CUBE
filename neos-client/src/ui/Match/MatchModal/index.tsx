      ...
      <div className={styles["inputs-container"]}>
        <Select
          ...
          options={[
            {
              value: KOISHI_INDEX,
              label: serverConfig[KOISHI_INDEX]?.name || i18n("KoishiServer"),
            },
            {
              value: PRERELEASE_INDEX,
              label: serverConfig[PRERELEASE_INDEX]?.name || i18n("UltraPreemptiveServer"),
            },
            {
              value: ENV_408,
              label: serverConfig[ENV_408]?.name || i18n("408"),
            },
          ]}
